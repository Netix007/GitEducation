...
Для просмотра инструкции к любой команде в **Git** необходимо выполнить команду __*git <имя_команды> --help*__. Например, __*git log --help*__ - после выплнения команды на экран будет выведена инструкция к команде __*log*__.
